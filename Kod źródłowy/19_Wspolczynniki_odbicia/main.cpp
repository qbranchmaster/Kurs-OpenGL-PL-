...
glm::vec3 camera_position(5.0, 3.0, 0.0);
glm::vec3 camera_direction(-1.0, 0.0, 0.0);
glm::vec3 camera_right(0.0, 0.0, 1.0);
glm::vec3 camera_up;
                      ...
                      std::vector<GLuint>& textures)
{
    ...
    for (int i = 0; i != scene->mNumMeshes; i++)
    {
        ...
        // W tej lekcji tekstury ladowane sa oddzielnie w celu uproszczenia kodu
...
int main()
{
    ...
    LoadSceneFromFile("Barrel/Barrel.obj", vao1, vertices_count,
    ...
    if (LoadTexture("Barrel/MedBarrelDiffuse.jpg", texture_0))
        return -1;

    GLuint texture_1;
    glActiveTexture(GL_TEXTURE1);
    if (LoadTexture("Barrel/MedBarrelSpecular.jpg", texture_1))
        return -1;

    GLint texture_slot_0 = glGetUniformLocation(shaders, "diffuse_texture");
    glUniform1i(texture_slot_0, 0);
    GLint texture_slot_1 = glGetUniformLocation(shaders, "specular_texture");
