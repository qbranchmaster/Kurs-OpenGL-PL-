...
int main()
{
    ...
    GLuint normals_vbo1 = 0;
    glGenBuffers(1, &normals_vbo1);
    glBindBuffer(GL_ARRAY_BUFFER, normals_vbo1);
    glBufferData(GL_ARRAY_BUFFER, sizeof(normals_cube), normals_cube,
                 GL_STATIC_DRAW);
    ...
    GLuint normals_vbo2 = 0;
    glGenBuffers(1, &normals_vbo2);
    glBindBuffer(GL_ARRAY_BUFFER, normals_vbo2);
    glBufferData(GL_ARRAY_BUFFER, sizeof(normals_floor), normals_floor,
                 GL_STATIC_DRAW);
