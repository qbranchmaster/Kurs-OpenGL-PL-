...
glm::vec3 camera_position(-4.0, 5.0, -10.0);
...
int main()
{
    ...
    MeshHandle farmhouse;
    loadSceneFromFile("Stone Bridge/stone_bridge.obj", farmhouse);
    glm::mat4 model_matrix = glm::scale(glm::mat4(1.0f), glm::vec3(0.5,0.5,0.5));
